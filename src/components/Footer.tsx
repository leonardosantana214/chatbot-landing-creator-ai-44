          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <img 
                ...
                className="h-8 w-8"
              />
              <span className="text-2xl font-bold">Techcorps</span>
            </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#FF914C] transition-colors"
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-gray-300 hover:text-[#FF914C] transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div id="contact">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">contato@techcorps.com</span>
              </div>
              
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-[#FF914C]" />
                <span className="text-gray-300">+55 11 94117-9868</span>
              </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} Techcorps. Todos os direitos reservados.
            </p>
